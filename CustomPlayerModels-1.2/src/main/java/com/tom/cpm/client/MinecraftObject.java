...
public class MinecraftObject implements MinecraftClientAccess {
	...
	public static class Texture implements ITexture {
		...
		public void load(Image image) {
			...
			FMLClientHandler.instance().getClient().renderEngine.setupTexture(AWTImageIO.toBufferedImage(image), id);
		}

		@Override
		public void free() {
			FMLClientHandler.instance().getClient().renderEngine.deleteTexture(id);
			id = -1;
		}
