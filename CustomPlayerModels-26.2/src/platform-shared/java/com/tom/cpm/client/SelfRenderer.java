...
public interface SelfRenderer {
	...
	public static record RenderCollector(PoseStack pose, OrderedSubmitNodeCollector collector, RenderType defaultRt, int light, int overlay, int tint, int outline, TextureAtlasSprite sprite, float lw, Object state) {
