...
import com.tom.cpm.mixin.HumanoidModelAccessor;
...
public class PlayerProfile extends Player<net.minecraft.world.entity.player.Player> {
	...
	public void updateFromState(AnimationState animState, PlayerModel model, PlayerRenderState state) {
		...
		HumanoidModelAccessor a = (HumanoidModelAccessor) model;
		animState.leftArm = ArmPose.of(a.callGetArmPose(state, HumanoidArm.LEFT));
		animState.rightArm = ArmPose.of(a.callGetArmPose(state, HumanoidArm.RIGHT));
	}
