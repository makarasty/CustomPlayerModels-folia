...
public abstract class ClientBase {
	...
	public static boolean irisLoaded, vrLoaded;
	...
	public void init1() {
		...
		netHandler.setDisplayText(t -> Minecraft.getInstance().player.sendSystemMessage(t.remap()));
	...
	public static void apiInit() {
		...
		renderApi(Model.class, Identifier.class, RenderType.class, Void.class, GameProfile.class, ModelTexture::new).
