...
public class AttributeScaler implements ScalerInterface<Player, List<Attribute>> {
    ...
    public String getMethodName() {
        return ScalerInterface.ATTRIBUTE;
    }

    @Override
    public void setScale(List<Attribute> key, Player player, float value) {
        // Folia Fix: Always apply attributes exactly on the Entity Scheduler
        player.getScheduler().run(CPMBukkitPlugin.getInstance(), task -> {
            key.forEach(a -> {
